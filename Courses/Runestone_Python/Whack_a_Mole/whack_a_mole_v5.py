...
Source: https://runestone.academy/runestone/books/published/thinkcspy/GUIandEventDrivenProgramming/11_gui_program_example.html#a-whack-a-mole-game

2 images will need to be placed at the level of this file
1) mole.png
2) mole_cove.png 
