...
3.3.1.5 | URL Structue for REST APIs | 3 parts of the URL (1) the endpoint URL (2)the question mark: (3) the query (key/value pair(s) seperated by a &), for example: https://www.google.com/search?q=linkedin (1) https://www.google.com/search  (2) ? (3) q=linkedin .... or https://www.linkedin.com/search/results/all/?keywords=google&origin=GLOBAL_SEARCH_HEADER (1) https://www.linkedin.com/search/results/all/  (2) ?  (3) keywords=google&origin=GLOBAL_SEARCH_HEADER  | 
