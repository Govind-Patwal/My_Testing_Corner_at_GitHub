...
4.2.6 | invoking a parent class's method (SINGLE parent) - syntax | >>>`super().<method_name>(variable(s))` ... the code goes after the declaration of the method of the subclass ...most commom usage: constructor ...eg. >>> `def __init__ (self, var_in_parent_const_1, var_in_parent_const_1, ...new_subclass_variable_1, new_subclass_variable_1,...):` \n `super().__init__(var_in_parent_const_1, var_in_parent_const_1, ...)` | 
