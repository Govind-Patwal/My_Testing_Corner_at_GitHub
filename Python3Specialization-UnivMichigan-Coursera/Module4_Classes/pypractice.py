...
# #     def __init__(self, name='Brr', level = 5):
# #         self.name = name
# #         self.level = level
...
# # #     #     Pokemon.__init__(self, name='Brr', level = 5)
# # #     #     self.age = age

# # #     # return value test
# # #     def test_addition_of_squares(self):
# # #         f1 = lambda x, y : x**2 + y **2
# # #         self.assertEqual(f1(2,3),13)

# # #     # side effect /mutation test
...
# #     # self.assertEqual(add_to_list(list1), list2)
...
# # assert add_to_list(list1) == list2
